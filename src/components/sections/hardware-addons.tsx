...
const hardware = [
  {
    ...
    price: '৳১,৪৯৯',
    image:
      'https://www.startech.com.bd/image/cache/catalog/scanner/winson/wnl-1051/wnl-1051-02-500x500.jpg',
    dataAiHint: 'barcode scanner',
    description:
      'দ্রুত এবং নির্ভুলভাবে পণ্য স্ক্যান করে আপনার বিলিং প্রক্রিয়াটিকে আরও দ্রুত করুন।',
  },
  {
    name: 'পস প্রিন্টার',
    price: 'আলোচনা সাপেক্ষ',
    image:
      'https://www.startech.com.bd/image/cache/catalog/printer/rongta/rp58e-u/rp58e-u-1-500x500.jpg',
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 grid gap-8 md:grid-cols-2">
          {hardware.map((item, index) => (
            <Card
              key={index}
              className="flex flex-col md:flex-row items-center overflow-hidden glow-card"
            >
